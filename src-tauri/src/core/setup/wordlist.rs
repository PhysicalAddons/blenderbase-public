//! The EFF short wordlist (1,296 words of 3 to 5 letters, chosen to be easy to say and to
//! type), for transfer codes such as `brave-otter-4412`. Source: https://www.eff.org/dice.
//! Its one hyphenated entry, `yo-yo`, is replaced by `yolk`: a hyphen would clash with the
//! code's own separators.

pub const TRANSFER_WORDS: [&str; 1296] = [
    ...
    "yield", "yolk", "yodel", "yoga", "yoyo", "yummy", "zebra", "zero", "zesty", "zippy", "zone", "zoom",
];
